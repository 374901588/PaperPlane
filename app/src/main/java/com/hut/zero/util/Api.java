...
public class Api {
    ...
    // 热门消息
    // hot Posts
    // 请注意！ 此 API 仍可访问，但是其内容未出现在最新的『知乎日报』 MyApplication 中。
    ...
    // Guoke handpick articles. make complete url by combining params
    ...
    // 获取果壳文章的具体信息 V1
    // specific information of guoke post V1
    public static final String GUOKE_ARTICLE_LINK_V1 = "http://jingxuan.guokr.com/pick/";

    // 获取果壳文章的具体信息 V2
    // V2
    // public static final String GUOKE_ARTICLE_LINK_V2 = "http://jingxuan.guokr.com/pick/v2/";

    // 获取果壳精选的轮播文章列表
    // carousel Posts
    // public static final String GUOKE_HANDPICK_CAROUSEL = "http://apis.guokr.com/flowingboard/item/handpick_carousel.json";
